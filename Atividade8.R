...
library(stringr)#Necessário carregar este pacote para a função de extrair strings
...
#Dataset utilizado para as próximas questões
...
v1
#A resota seria 156 países que atende a pelo menos 1 dos requisitos da questão